...
import br.com.pzg.project.two.persistence.CorpEventsDataService;
...
public class CompanyEventHandler {
    ...
    private final CorpEventsDataService dataSvc;

    public CompanyEventHandler(CorpEventsDataService dataSvc) {
